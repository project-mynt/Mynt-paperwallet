"ua": {
  "choosecurrency": "Оберіть валюту",
    ...
    "donate": "Пожертвувати",
    "generatelabelmyntaddress": "Створюється нова адреса...",
    ...
    "singlelabelmyntaddress": "Публічна адреса",
    ...
    "securitystep0": "Насамперед <strong>завантажте</strong> цей сайт з <a href=\"https://github.com/project-mynt/Mynt-paperwallet/releases\">Github</a>, розархівуйте його і безпосередньо з вашого комп'ютера відкрийте файл index.html. Це достатньо просто сховати деякий шкідливий код у 6000+ рядків javascript, щоб поцупити ваш приватний ключ, але ви ж не хочете довідатися, що ваші кошти вкрадено. Контроль версії кода дозволяє набагато простіше перевіряти діючу програму. Для забезпечення додаткової безпеки, <strong>відключіть доступ до Інтернету</strong> під час створення вашого гаманця.",
    ...
    "brainlabelmyntaddress": "Публічна адреса:",
    ...
    "detaillabelmyntaddress": "Публічна адреса",
    "detaillabelmyntaddresscomp": "Публічна адреса (стиснута)",
    ...
    "footersupport": "Підтримати Mynt-paperwallet",
    ...
    "defaultTitle": "Mynt-paperwallet - універсальний генератор паперових гаманців для біткойнів та інших криптовалют",
