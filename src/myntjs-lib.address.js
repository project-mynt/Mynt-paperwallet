...
Mynt.Address = function (bytes) {
	if ("string" == typeof bytes) {
		bytes = Mynt.Address.decodeString(bytes);
	}
	this.hash = bytes;
};
...
*/
Mynt.Address.prototype.toString = function () {
	...
	return Mynt.Base58.encode(bytes);
};

Mynt.Address.prototype.getHashBase64 = function () {
	return Crypto.util.bytesToBase64(this.hash);
};

/**
* Parse a Mynt address contained in a string.
*/
Mynt.Address.decodeString = function (string) {
	var bytes = Mynt.Base58.decode(string);
